...
public class ReadySMTPS { // Prepared SMTP server responses
    ...
    public static String acceptance() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.READY)
                .domain()
    ...
    public static String badCommand() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.INTERNAL_SERVER_ERROR)
    ...
    public static String badSyntax() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.BAD_SYNTAX)
    ...
    public static String badSequence() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.BAD_SEQUENCE)
    ...
    public static String acknowledge() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.ACKNOWLEDGE)
                .message("OK")
                .get();
    }
    ...
    public static String authSuccess() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.AUTH_SUCCESS)
    ...
    public static String authFailed() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.AUTH_FAIL)
                .message("Auth failed")
                .get();
    }
    ...
    public static String transactionFailed() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.FAILURE)
    ...
    public static String startMail() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.START_MAIL_INPUT)
    ...
    public static String advertiseTLS() {
        return new SMTPBuilder()
                .status(Code.ESMTP_STATUS.ACKNOWLEDGE, true)
                .message("STARTTLS")
                .get();
    }
